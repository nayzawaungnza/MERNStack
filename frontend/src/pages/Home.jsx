      ...
      <div className="space-y-3">
        <div className="bg-white p-5 rounded-2xl space-y-3">
          ...
          <p>
            ...
            ducimus reiciendis harum ipsum quis nesciunt, aut nemo sit cumque
            veritatis quaerat repellendus praesentium aliquid saepe mollitia
            animi. Cum, modi placeat.
          </p>
